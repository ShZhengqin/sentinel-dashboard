...
public class ParamFlowRuleControllerV2 {
    ...
    @GetMapping("/rules")
    public Result<List<ParamFlowRuleEntity>> apiQueryMachineRules(HttpServletRequest request, @RequestParam String app) {
    ...
    public Result<ParamFlowRuleEntity> apiAddParamFlowRule(HttpServletRequest request, @RequestBody ParamFlowRuleEntity entity) {
        ...
        try {
            ...
            logger.error("Failed to add paramFlow rule", throwable);
            return Result.ofThrowable(-1, throwable);
        }
    ...
    public Result<ParamFlowRuleEntity> apiUpdateParamFlowRule(HttpServletRequest request,
        ...
        try {
            ...
            logger.error("Failed to update paramFlow rule", throwable);
            return Result.ofThrowable(-1, throwable);
        }
        return Result.ofSuccess(entity);
    }
